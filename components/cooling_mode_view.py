...
def render_cooling_mode_view(current_metrics: Dict[str, Any], df_forecast: pd.DataFrame) -> None:
            ...
            <div class="kpi-card" style="padding: 1.25rem;">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 0.85rem;">
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <span style="font-size: 0.88rem; font-weight: 700; color: #0F172A;">Dispatch Mode:</span>
                        {get_mode_badge_html(rec_mode)}
                    </div>
                    <span style="background: #F1F5F9; color: #334155; border: 1px solid #E2E8F0; padding: 2px 8px; border-radius: 4px; font-size: 0.7rem; font-weight: 600;">
                        ASHRAE TC 9.9
                    </span>
                </div>

                <div style="font-size: 0.82rem; color: #334155; line-height: 1.5; margin-bottom: 0.85rem;">
                    <div style="font-weight: 600; color: #0F172A; margin-bottom: 4px;">Engine Reasoning:</div>
                    <div style="color: #475569;">{mode_reason}</div>
                    <div style="margin-top: 6px; padding-left: 0.75rem; border-left: 2px solid #E2E8F0; font-size: 0.78rem;">
                ...
                <div style="background: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 6px; padding: 0.55rem 0.8rem; font-size: 0.78rem; color: #334155;">
                    <span style="font-weight: 600;">Transition Forecast:</span> {transition_info}
                </div>
            </div>
            """,
    ...
    with col_right:
        ...
        fig_ashrae.add_shape(
            ...
            fillcolor="rgba(236, 253, 245, 0.5)",
            layer="below",
        )
        ...
        fig_ashrae.add_trace(
            go.Scatter(
                ...
                marker=dict(size=9, color="#0F172A", symbol="circle", line=dict(width=1.5, color="#FFFFFF")),
